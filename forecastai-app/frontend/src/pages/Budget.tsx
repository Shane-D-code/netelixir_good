...
import { useSimulateBudget, useOptimizeBudget } from '../hooks/useForecast';
import { formatCurrency, formatROAS, classNames } from '../utils/formatters';
import { VALID_CHANNELS } from '../utils/validators';
import { useQuery } from '@tanstack/react-query';
import { budgetAPI } from '../services/forecastService';
