      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex gap-4">
            <span className="cursor-pointer" style={{ color: 'var(--text-tertiary)', fontSize: '12px' }}>Privacy</span>
            <span className="cursor-pointer" style={{ color: 'var(--text-tertiary)', fontSize: '12px' }}>Terms</span>
            <span className="cursor-pointer" style={{ color: 'var(--text-tertiary)', fontSize: '12px' }}>Docs</span>
          </div>
        </div>
      </div>
    </footer>
