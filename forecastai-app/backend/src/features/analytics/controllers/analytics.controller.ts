...
import { campaignAnalyzer } from '../services/campaign-analyzer.service';
import { seasonalityDetector } from '../services/seasonality-detector.service';
import { roasOptimizer } from '../../budget/services/roas-optimizer.service';
import { dataValidator } from '../../upload/services/data-validator.service';
import { causalInferenceEngine } from '../services/causal-inference.service';
import { operationalInsightsGenerator } from '../services/operational-insights.service';
...
export async function getAnomalies(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const { runForecastPipeline } = require('../services/ml.service');
